...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <hr> 
      <center><h2 class="h2"> Parcial Diario Top5</h2></center> 
...
<?php
    $suma_liquido = 0;
    include("cone.php"); 
    $consulta = "SELECT * FROM `valordiario` order by Valor desc LIMIT 0,5";
...
?> 
    ...
    <script>
        ...
        let url = 'URL OF THE API BY WHICH THE GRAPHICS WORK/sistema-interno/chart_mysql4/graficos.php'
        fetch(url)
        ...
        const mostrar = (articulos) =>{
            articulos.forEach(element => {
                myChart.data['labels'].push(element.Nome)
     ...
     <script>
        ...
        let url = 'https://consegenterprise.com.br/sistema-interno/chart_mysql4/graficos.php'
        fetch(url)
