...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <hr> 
      <center><h2 class="h2"> Parcial Diario Lojas </h2></center> 
   ...
   <?php
    ...
    include("cone.php"); 
    $consulta = "SELECT * FROM `valorlojatoday` order by Valor desc";
...
?> 
    ...
    <script>
        ...
        let url = 'URL OF THE API BY WHICH THE GRAPHICS WORK/sistema-interno/chart_mysql5/graficos.php'
        fetch(url)
